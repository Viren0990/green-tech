        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="/story" className="hover:text-green-500 transition">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/story" className="hover:text-green-500 transition">About Us</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>Wagholi, Pune, Maharashtra, India</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone size={18} className="text-green-500" />
                <a href="tel:+919120676799" className="hover:text-green-500 transition">
                  +91 9075010115
                </a>
              </li>
              <li className="flex items-center gap-2">
