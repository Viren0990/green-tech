...
export default function GalleryHero({ postCount }: { postCount: number }) {
  return (
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center justify-center py-10">
          ...
          <div className="mb-6 w-16 h-16 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center backdrop-blur-sm">
            <Images size={28} className="text-emerald-400" />
          </div>
          ...
          <p className="text-gray-400 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto" style={{ fontFamily: 'system-ui, sans-serif' }}>
            Explore how we give technology a second life — recycling, refurbishing, and contributing to a greener future.
          </p>

          {/* Stats */}
          <div className="mt-8 flex items-center justify-center gap-6 text-sm" style={{ fontFamily: 'system-ui, sans-serif' }}>
            <div className="flex items-center gap-2 text-gray-300">
              <span className="text-emerald-400 font-bold text-lg">{postCount}</span>
              <span>Projects</span>
            </div>
