...
export const metadata: Metadata = {
  ...
  description: 'India\'s premier certified e-waste recycling and refurbishment service. We provide secure data destruction, responsible recycling, and device restoration across India. Join DMD Green Tech in building a sustainable circular economy.',
  keywords: [
    'DMD Green Tech',
    'DMD',
